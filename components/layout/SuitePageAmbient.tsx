    ...
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden>
      ...
      <div
        ...
        style={
          reduceMotion
            ? { animation: 'none' }
            : { animation: 'suite-breathe 13s ease-in-out infinite' }
        }
      >
      ...
      <div
        ...
        style={
          reduceMotion
            ? { animation: 'none' }
            : { animation: 'suite-breathe 16s ease-in-out infinite', animationDelay: '-4s' }
        }
      >
      ...
      <div className="absolute left-1/2 top-1/2 h-[min(68vw,34rem)] w-[min(68vw,34rem)] -translate-x-1/2 -translate-y-1/2 sm:h-[40rem] sm:w-[40rem]">
        <div
          ...
          style={
            reduceMotion
              ? { animation: 'none' }
              : { animation: 'suite-breathe 19s ease-in-out infinite', animationDelay: '-8s' }
          }
        >
